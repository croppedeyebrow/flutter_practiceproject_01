...
import 'package:flutter_telegrame_clone/json/setting_json.dart';
...
class _SettingPageState extends State<SettingPage> {
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Container(
                          ...
                          child: Center(
                            child: Icon(setting_section_one[index]['icon'],
                                color: white, size: 20),
                          )),
                      SizedBox(width: 12),
                      Text(setting_section_one[index]['text'],
                          style: TextStyle(
                              fontSize: 16,
                              color: white,
                              fontWeight: FontWeight.w500))
                  ...
                  Icon(Icons.arrow_forward_ios,
                      color: white.withAlpha(20), size: 14)
                ],
              )
            ]),
          ));
                    ...
                    children: [
                      Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(8)),
                          child: Center(
                            child: Icon(setting_section_two[index]['icon'],
                                color: white, size: 20),
                          )),
                      SizedBox(width: 12),
                      Text(setting_section_two[index]['text'],
                          style: TextStyle(
                              fontSize: 16,
                              color: white,
                              fontWeight: FontWeight.w500))
  ...
  getLangAndSticker(value) {
    ...
    } else if (value == 'Stickers and Emojis') {
      return Badge(
          backgroundColor: primary,
          label: Text("12",
              style: TextStyle(fontSize: 15, color: white.withAlpha(50))));
    }
    return Container();
  }
                    ...
                    children: [
                      Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(8)),
                          child: Center(
                            child: Icon(setting_section_three[index]['icon'],
                                color: white, size: 20),
                          )),
                      SizedBox(width: 12),
                      Text(setting_section_three[index]['text'],
                          style: TextStyle(
                              fontSize: 16,
                              color: white,
                              fontWeight: FontWeight.w500))
